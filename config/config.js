var config = {
  ...
  portfolio: [
    ...
    [
      "./images/fthb-engine.svg",
      "https://victorious-sand-0e698241e.4.azurestaticapps.net/",
      "FTHB Engine Website",
      "Azure-hosted dashboard that displays FIS scores generated by the FTHB AI framework for fixed-income research and ethical analysis.",
    ],
  ],
